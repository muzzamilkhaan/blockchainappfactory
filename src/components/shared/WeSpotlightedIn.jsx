      ...
      <div className="newsletter_videos">
        <div className="newsletter_videos_numbers">
          <div className="section-title text-center">
            <h5 className="common_h3">History is Boring! But numbers aren't!</h5>
            <hr />
          </div>
          <ul className="ul-style-4 list_growth m-t-50 history_ul">
            ...
            <li>
              <span><GrTasks /></span> Projects in
              progress <strong>50+</strong>
            </li>
            <li>
              <span><FaUsers /></span> Team{" "}
              <strong>500+</strong>
            </li>
            <li>
              <span><FaUsers /></span> Blockchain Experts{" "}
              <strong>150+</strong>
            </li>
          </ul>
        </div>
            ...
            <div className="col-md-5">
              <div className="contact-content">
                <p>
                  ...
                  technology! Reach out to us today and discuss your project or
                  ask your queries to our proficient web3 experts.
                </p>
                <hr />
