...
function CreateYourOwnTokenAndCoin({
  ...
  return (
    <>
      <div
        id="create-your-own-token-and-coin"
      ...
      >
        ...
        <div className="main">
          ...
          <div className="container coin-fill-form">
            ...
            <div
              className="col-md-6 col-sm-12 col-xs-12 sec-side-right"
              style={{
                display: "flex",
                alignItems: "center",
                minHeight: 700,
