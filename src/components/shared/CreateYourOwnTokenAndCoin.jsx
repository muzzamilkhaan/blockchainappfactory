...
function CreateYourOwnTokenAndCoin() {
    ...
    return (
        <>
            <div id='create-your-own-token-and-coin'>
                <Header />
                <div className="main">
                                        ...
                                        <div className="ovr">
                                            <div className="col-md-12 col-sm-12 col-xs-12 text-left">
                                                <div className="ban_tirt">
                                                    ...
                                                    <p itemProp="text" className="text-center">
                                                        Do you want to create your own token? You are merely steps
                                                        away from realizing your crypto business dreams! Speak with
                                                        our seasoned crypto developers who create token projects
                                                        efficiently.
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="col-md-6 col-sm-12 col-xs-12 text-center">
                                                <div className="free-consult">
                                                    <h2>Fill out the form so that we can discuss further!</h2>
                                                    <div className="tabs">
                                                        <div className="tabby-tab">
                                                            <input
                                                                ...
                                                                name="tabby-tabs"
                                                                checked={tab1}
                                                                onClick={() => { setTab1(true), setTab2(false) }}
                                                            />
                                                            ...
                                                            <div className="tabby-content">
                                                                <form id="msform">
                                                                    <ul id="progressbar">
                                                                        ...
                                                                        <li id="personal" className={`${tab1State === 1 ? 'active' : ''}`}>
                                                                    ...
                                                                    {tab1State === 0 ?
                                                                        <fieldset>
                                                                            <div className="form-card">
                                                                                ...
                                                                                <select name="whitepaper" id="whitepaper">
                                                                                    <option selected="" value="">
                                                                                ...
                                                                                <select name="campaign" id="campaign">
                                                                                    <option selected="" value="">
                                                                                        Do You Need a Crypto Fundraising Campaign?: *
                                                                                    </option>
                                                                                    <option value="Yes - ICO">Yes - ICO</option>
                                                                                    <option value="Yes - IEO">Yes - IEO</option>
                                                                                    <option value="Yes - STO">Yes - STO</option>
                                                                                    <option value="Yes - IDO">Yes - IDO</option>
                                                                                    <option value="No">No</option>
                                                                                </select>
                                                                            </div>{" "}
                                                                            <input
                                                        ...
                                                        <div className="tabby-tab">
                                                            <input
                                                                ...
                                                                name="tabby-tabs"
                                                                checked={tab2}
                                                                onClick={() => { setTab1(false), setTab2(true) }}
                                                            />
                                                            ...
                                                            <div className="tabby-content">
                                                                <form id="msform">
                                                                    <ul id="progressbar">
                                                                        ...
                                                                        <li id="confirm" className={`${tab2State === 1 ? 'active' : ''}`}>
                                                                            <strong>Step 2</strong>
                                                                        </li>
                                                                    </ul>
                                                                    {tab2State === 0 ?
                                                                        <fieldset>
                                                                            <div className="form-card">
                                                                                ...
                                                                                <select name="blockchain" id="token_blockchain">
                                                                                    <option selected="" value="">
                                                                                        Select Blockchain: *
                                                                                    </option>
                                                                                    <option value="Ethereum">Ethereum</option>
                                                                                ...
                                                                                <select name="whitepaper" id="token_whitepaper">
                                                                                    <option selected="" value="">
                                                                                        Do You Need a Whitepaper?: *
                                                                                    </option>
                                                                                    <option value="Yes">Yes</option>
                                                                                ...
                                                                                <select name="campaign" id="token_campaign">
                                                                                    <option selected="" value="">
                                                                                        Do You Need a Crypto Fundraising Campaign?: *
                                                                                    </option>
                                                                                    <option value="Yes - ICO">Yes - ICO</option>
                                            ...
                                            >
                                                <div itemScope="" itemType="http://schema.org/CreativeWork">
                                                    <h2>
                                                        We Can Answer the Most Pressing Questions You Might Have:
                                                    </h2>
                                                    <ul className="banner-list">
                                                        <li>
                                                            Do you want to create your own coin but need clarification
                                                            on how?
                                                        </li>
                                                        <li>
                                                            Are you unsure of your token project’s feasibility as a
                                                            business?
                                                        </li>
                                                        <li>
                                                            Do you want to know how to create your own token business?
                                                        </li>
                                                        <li>Want to launch crypto coin on the best blockchains?</li>
                                                        <li>
                                                            Looking to utilize an advancing business model for the
                                                            future?
                                                        </li>
                                                    </ul>
                                                    <p itemProp="text">
                                                        And everything else! We are here to assist you with our
                                                        industry and technology expertise to power your dream
