...
import './whiteLabelCryptocurrencyExchangeSoftwareDevelopment.css'

function WhiteLabelCryptocurrencyExchangeSoftwareDevelopment() {
  return (
    <>
      <div id='white-label-cryptocurrency-exchange-software-development' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default WhiteLabelCryptocurrencyExchangeSoftwareDevelopment