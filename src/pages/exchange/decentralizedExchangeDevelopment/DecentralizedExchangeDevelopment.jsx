...
import './decentralizedExchangeDevelopment.css'

function DecentralizedExchangeDevelopment() {
  return (
    <>
      <div id='decentralized-exchange-development' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default DecentralizedExchangeDevelopment