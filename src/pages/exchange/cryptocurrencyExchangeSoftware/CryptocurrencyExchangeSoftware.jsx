...
import './cryptocurrencyExchangeSoftware.css'

function CryptocurrencyExchangeSoftware() {
  return (
    <>
      <div id='cryptocurrency-exchange-software' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default CryptocurrencyExchangeSoftware