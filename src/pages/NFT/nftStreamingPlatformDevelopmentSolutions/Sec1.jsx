...
import { SecOne } from "./nftStreamingPlatformDevelopmentSolutionsComp";
                ...
                <div className="contentall">
                  <div className="ovr">
                    <div className="ban_tirt">
                      <h1>NFT Streaming Platform</h1>
                    </div>
                    <p>
                      Experience the combo of NFT and a streaming platform that
                      showers the abundant benefits with its flamboyance
                    </p>
