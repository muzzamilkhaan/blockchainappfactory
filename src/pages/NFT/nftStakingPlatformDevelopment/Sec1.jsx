...
import { SecOne } from "./nft-staking-platform-developmentComp";
            ...
            <div className="row">
              <div className="col-md-6 col-sm-12 col-xs-12 text-left">
                <div className="contentall">
                  <div className="banner_tit_text">
                    <div className="ban_tirt">
                      <h1>NFT Staking platform development services</h1>
                    </div>
                    <p>
                      A well-developed, reliable platform to Stake NFT and avail
                      rewards.
                    </p>
              ...
              <div className="col-md-6 col-sm-12 col-xs-12 text-center mt50"> </div>
            </div>
          </div>
        </div>
      </div>
