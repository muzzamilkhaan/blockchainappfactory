...
import { SecOne } from "./nftMarketplaceSidechainComp";
                ...
                <div className="contentall">
                  <div className="">
                    <div className="ban_tirt">
                      <h1>NFT Development in Sidechain </h1>
                    </div>
                    <p className="">
                      Boost your NFT developments with the industry’s best
                      Sidechains. Introducing the NFT development in Sidechain
