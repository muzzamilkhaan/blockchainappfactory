...
import { SecOne } from "./nftMarketplaceForCelebritiesComp";
                ...
                <div className="contentall">
                  <div className="">
                    <div className="ban_tirt">
                      <h1>NFT Marketplace For Celebrities</h1>{" "}
                    </div>
                    <p className="">
                      Leverage the relationship between celebrities and fans by
                      bringing digital solutions - Developing Celebrity NFT
                      Marketplace is the ideal way to set a novel trend in the
                      space.
                    </p>
