...
import { SecOne } from "./nftLaunchpadDevelopmentServiceComp";

const Sec1 = () => {
  return (
    <SecOne className="main">
                ...
                <div className="contentall">
                  <div className="bnr_content">
                    <div className="ban_tirt">
                      <h1>
                        NFT Launchpad Development - Fueling Creators To Launch
                        NFTs
                      </h1>{" "}
                    </div>
                    <p>
                      Amplifying NFTs to the world with pioneering intellectual
                      strategies, marketing abilities through a reliable
                      platform.
                    </p>
                    <div className="">
                      <style
