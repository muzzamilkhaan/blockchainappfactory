...
import './whiteLabelNftMarketplace.css'

function WhiteLabelNftMarketplace() {
  return (
    <>
      <div id='white-label-nft-marketplace' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default WhiteLabelNftMarketplace