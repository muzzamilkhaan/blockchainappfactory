...
import './bitcoinOrdinalsMarketplaceDevelopment.css'

function BitcoinOrdinalsMarketplaceDevelopment() {
  return (
    <>
      <div id='bitcoin-ordinals-marketplace-development' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default BitcoinOrdinalsMarketplaceDevelopment