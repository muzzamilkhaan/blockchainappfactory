...
import { SecOne } from "./nftMusicMarketplaceDevelopmentComp";
const Sec1 = () => {
  return (
    <SecOne>
              ...
              <div className="col-md-5 col-sm-12 col-xs-12 text-left">
                <div className="contentall">
                  ...
                  <p className="text-white para">
                    {" "}
                    Music NFT overheads the business trends with the flamboyance
...
.contentall a, a.home-talk-experts{
	padding: 10px 20px !important;
              ...
              <div className="col-md-7 col-sm-12 col-xs-12 text-center">
                <img
                  src="https://www.blockchainappfactory.com/images/nft_music/nft_music.webp"
                  alt=""
                  title=""
                />
              </div>
