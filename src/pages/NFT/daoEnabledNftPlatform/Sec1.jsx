...
import { SecOne } from "./daoEnabledNftPlatformComp";
                ...
                <div className="contentall">
                  <div className="overlay">
                    <div className="ban_tirt">
                      <h1>Best DAO-enabled NFT Platform Development</h1>
                    </div>
                    <p>
                      Decentralization is the core of the Web3 world, and a
                      DAO-enabled NFT platform can be the ideal weapon to bring
                      forward changes.
                    </p>
                    {/* <style type="text/css">
.nec-btn{
