...
import { SecOne } from "./nftForRealeStateComp";
              ...
              <div className="col-md-5 col-sm-12 col-xs-12 text-left">
                <div className="contentall">
                  <div className="ban_tirt ">
                    <h1 className="text-dark">NFT Marketplace for Real estate</h1>
                  </div>
                  <p className="text-dark para">
                    NFT Real estate Marketplace - collaborating real-world
                    aspects virtually in a decentralized medium through NFTs
                  </p>
...
.contentall a, a.home-talk-experts{
	padding: 10px 20px !important;
              ...
              <div className="col-md-7 col-sm-12 col-xs-12 text-center"> </div>
            </div>
          </div>
        </div>
      </div>
