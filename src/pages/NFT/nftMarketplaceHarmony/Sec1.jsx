...
import { SecOne } from "./nftMarketplaceHarmonyComp";
                ...
                <div className="contentall">
                  <div className="">
                    <div className="ban_tirt">
                      <h1>NFT Marketplace Development in Harmony</h1>
                    </div>
                    <p className="">
                      Proceed with your business ventures on your own NFT
                      marketplace with a powerful and high-speed blockchain
                      technology like Harmony.
                    </p>
