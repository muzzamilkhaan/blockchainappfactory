                ...
                <div className="left ">
                  <div className="ban_cnt">
                    <h1 className="title-banner">
                      Enterprise Blockchain Technology Solution &amp; Services
                      Provider
                    </h1>
                    <p className="title-para">
                      Advanced and reliable blockchain technology solutions from
                      the experts. Enhance your business with our excellent Web
                      3.0 services
                    </p>{" "}
                    <a
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-xs-12 ">
                      ...
                      <div className="counter-text">
                        <h6 className="text-white">
                          ...
                          <span className="plus-icon ">+</span> Years
                        </h6>
                    ...
                    <div className="col-lg-3 col-sm-6  col-xs-12  ">
                      <div className="counter-icon">
                        <img
                          className="img-fuild"
                          src="./assets/images/employees.webp"
                          width="65px"
                          height="65px"
                          alt=""
                        />
                  ...
                  >
                    {" "}
                    <span className="abs-theme-bg"></span>
                    <div className="section-inner">
                      <div className="container">
                        <div className="row row-cols-5 text-center">
                          <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6 counter-wrapper single-counter mb-30">
                            <div className="counter-icon">
                              <img
                                className="img-fuild"
                                src="./assets/images/experience.webp"
