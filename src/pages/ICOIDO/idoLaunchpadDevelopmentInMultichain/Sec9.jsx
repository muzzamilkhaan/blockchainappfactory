  ...
  return (
    ...
    <div className="container">
      ...
      <p className="mt10 mb10 text-center">
        ...
        pioneers of the crypto space. And our team has already deployed many
        market-leading products which have a huge influence on the market. Our IDO
        launchpad Development in Multi-chain will be the market leader, and the
        owner of the platform will seriously have the chance to stay in the market
        growth that only the exclusive can see.
      </p>
