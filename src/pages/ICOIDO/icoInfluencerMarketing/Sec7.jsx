      ...
      <div className="row">
        ...
        <div className="col-md-12 text-center">
          <div className="Package_list" style={{ background: "#c0fcd9" }}>
            ...
            <img
              className="lazy"
              data-src="images/marketing-clients/sui-1.webp"
              alt=""
              src="./assets/images/icon-117.webp"
            />
            <span />{" "}
          </div>
          <div className="Package_list" style={{ background: "#c0fcd9" }}>
            ...
            <img
              ...
              alt=""
              src="./assets/images/icon-118.webp"
            />
            <span />{" "}
          </div>
          <div className="Package_list" style={{ background: "#c0fcd9" }}>
            ...
            <img
              ...
              alt=""
              src="./assets/images/icon-119.webp"
            />
            <span />{" "}
          </div>
          <div className="Package_list" style={{ background: "#c0fcd9" }}>
            ...
            <img
              ...
              alt=""
              src="./assets/images/icon-120.webp"
          ...
          <div className="Package_list" style={{ background: "#c0fcd9" }}>
            ...
            <img
              ...
              alt=""
              src="./assets/images/icon-121.webp"
          ...
          <div className="Package_list" style={{ background: "#c0fcd9" }}>
            ...
            <img
              ...
              alt=""
              src="./assets/images/icon-122.webp"
