          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div className="contentall">
                <h1>Comprehensive ICO Community Management Services</h1>
                <p className="justify">
                  {" "}
                  If it’s ICO community marketing services you’re looking for,
                  you’ve come to the right place! Welcome to Blockchain App
                  Factory - the one-stop-shop for all your ICO marketing needs.
                </p>
                <div className="">
                  <style
                    type="text/css"
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
              <div className="p2b_ban">
                {" "}
                <img
                  src="./assets/images/banner27.webp"
                  width={480}
                  alt="ICO Community Marketing"
                  title="Comprehensive ICO Community Management Services"
                />{" "}
              </div>
            </div>
          </div>
