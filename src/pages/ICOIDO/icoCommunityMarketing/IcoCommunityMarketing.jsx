...
import './icoCommunityMarketing.css'

function IcoCommunityMarketing() {
  return (
    <>
      <div id='ico-community-marketing' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default IcoCommunityMarketing