          ...
          <div className="col-md-6 col-sm-12 col-xs-12 text-left">
            <div className="contentall">
              ...
              <p className="text-dark">
                Start your new IDO Launchpad on Polygon, which has the best of
                both worlds with in-built features of Ethereum and a solution to
                combat the blockchain trilemma.{" "}
              </p>
              <div className="">
                <style
                  type="text/css"
