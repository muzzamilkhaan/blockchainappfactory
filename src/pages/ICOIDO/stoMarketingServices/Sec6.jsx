      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <p>
              We will market your offering through experts, advisors and other
              guest writers who will be talking about your project and the
              potential it can reach in the Security Token Market. These will be
              communicated through industry experts and we will help them
              provide content for the same. The mediums used by these experts
              are :
            </p>
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt50">
            <img
              src="./assets/images/sec-side80.webp"
              alt="Proxy Marketing"
