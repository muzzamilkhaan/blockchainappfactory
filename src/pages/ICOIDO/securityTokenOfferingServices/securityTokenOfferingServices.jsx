...
import "./securityTokenOfferingServices.css";
...
const securityTokenOfferingServices = () => {
  return (
    <div id="security-token-offering-services">
      <Sec1 />
      <Sec2 />
      <Sec3 />
      <Sec4 />
...
export default securityTokenOfferingServices;
