...
import './CryptocurrencyMLMSoftware.css'

function CryptocurrencyMLMSoftware() {
  return (
    <>
      <div id='cryptocurrency-mlm-software-development'style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        {/* <Sec3 />
...
export default CryptocurrencyMLMSoftware