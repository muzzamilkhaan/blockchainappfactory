...
import './decentralizedSportsBettingPlatform.css'

function DecentralizedSportsBettingPlatform() {
  return (
    <div id='decentralized-sports-betting-platform' style={{overflow : 'hidden'}}>
      <Header/>
      <Sec1/>
      <Sec2/>
      <Sec3/>
...
export default DecentralizedSportsBettingPlatform