...
function Sec4() {
  return (
    <section
  className="space-pt-1 bg-dark-half-md tech-padding teck-1"
...
>
  <div className="container">
    ...
    <div className="row container-center">
      <div className="col-md-3 col-sm-6 col-xs-6 mob-p-lr-6 equalize">
      ...
      <div className="col-md-3 col-sm-6 col-xs-6 mob-p-lr-6 equalize">
        <div className="boxy_client">
          ...
          />
          <p className="text-center" style={{ fontSize: 12 }}>
            We developed an NFT marketplace selling various digital assets for
            the firm.
          </p>
        </div>
      </div>
      <div className="col-md-3 col-sm-6 col-xs-6 mob-p-lr-6 equalize">
        <div className="boxy_client">
          ...
          />
          <p className="text-center" style={{ fontSize: 12 }}>
            We built an app to automate supply chain solutions between various
            end users.
          </p>
        </div>
      </div>
