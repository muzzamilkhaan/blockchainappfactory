...
import './cryptoPredictionMarketPlatform.css'

function CryptoPredictionMarketPlatform() {
  return (
    <div id='crypto-prediction-market-platform' style={{overflow : 'hidden'}}>
      <Header/>
      <Sec1/>
      <Sec2/>
      <Sec3/>
...
export default CryptoPredictionMarketPlatform