...
import './bitcoinOrdinalsTokenDevelopment.css'

function BitcoinOrdinalsTokenDevelopment() {
  return (
    <div id='bitcoin-ordinals-token-development' style={{overflow : 'hidden'}}>
      <Header/>
      <Sec1/>
      <Sec2/>
      <Sec3/>
...
export default BitcoinOrdinalsTokenDevelopment