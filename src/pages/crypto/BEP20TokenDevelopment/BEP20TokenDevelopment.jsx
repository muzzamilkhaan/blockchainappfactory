...
import './BEP20TokenDevelopment.css'

function BEP20TokenDevelopment() {
  return (
    <>
      <div id='binance-smart-chain-bep20-like-token-development' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        {/* <Sec3 />
...
export default BEP20TokenDevelopment