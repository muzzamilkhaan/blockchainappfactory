...
import './SRC20TokenDevelopment.css'

function SRC20TokenDevelopment() {
  return (
    <>
      <div id='src-20-token-development' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        <Sec3 />
...
export default SRC20TokenDevelopment