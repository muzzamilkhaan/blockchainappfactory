...
import './tokenizationPlatformDevelopment.css'

function TokenizationPlatformDevelopment() {
  return (
    <>
      <div id='tokenization-platform-development' style={{overflow : 'hidden'}}>
        <Header />
        <Sec1 />
        <Sec2 />
        {/* <Sec3 />
...
export default TokenizationPlatformDevelopment