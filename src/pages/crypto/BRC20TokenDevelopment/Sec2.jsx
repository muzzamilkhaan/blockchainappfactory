      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 col-sm-12 col-xs-12 text-center">
            <div className="section-title text-center"><h2 className="title-th sec_tit underline">Bitcoin’s BRC-20 Token Standard - Your Ticket To Crypto Success</h2> </div>
            <p className="text-center mt20">Breaking an all-time record in crypto history, Bitcoin’s new launch of the BRC-20 token standard has soared. The total supply of over 14,079 distinct tokens has recorded a dashing market capitalization of $962 million dollars. Having taken the inspiration from ERC-20 tokens, our unique BRC-20 token development solution allows the user to create and transfer tokens effortlessly.
              <br />
